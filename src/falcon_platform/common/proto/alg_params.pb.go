...
type MlpParams struct {
	...
	DpClipThreshold float64 `protobuf:"fixed64,16,opt,name=dp_clip_threshold,json=dpClipThreshold,proto3" json:"dp_clip_threshold,omitempty"`
	// Π_DPClip: Gaussian noise std-dev σ_dp; 0 = disabled
	DpNoiseSigma float64 `protobuf:"fixed64,17,opt,name=dp_noise_sigma,json=dpNoiseSigma,proto3" json:"dp_noise_sigma,omitempty"`
}
...
func (x *MlpParams) GetDpClipThreshold() float64 {
	if x != nil {
		return x.DpClipThreshold
	}
	return 0
}

func (x *MlpParams) GetDpNoiseSigma() float64 {
	if x != nil {
		return x.DpNoiseSigma
	}
	return 0
}
...
var file_alg_params_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x22, 0xed, 0x04, 0x0a, 0x09, 0x4d, 0x6c, 0x70, 0x50, 0x61, 0x72, 0x61, 0x6d,
	...
	0x73, 0x12, 0x2a, 0x0a, 0x11, 0x64, 0x70, 0x5f, 0x63, 0x6c, 0x69, 0x70, 0x5f, 0x74, 0x68, 0x72,
	0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x18, 0x10, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0f, 0x64, 0x70,
	0x43, 0x6c, 0x69, 0x70, 0x54, 0x68, 0x72, 0x65, 0x73, 0x68, 0x6f, 0x6c, 0x64, 0x12, 0x24, 0x0a,
	0x0e, 0x64, 0x70, 0x5f, 0x6e, 0x6f, 0x69, 0x73, 0x65, 0x5f, 0x73, 0x69, 0x67, 0x6d, 0x61, 0x18,
	0x11, 0x20, 0x01, 0x28, 0x01, 0x52, 0x0c, 0x64, 0x70, 0x4e, 0x6f, 0x69, 0x73, 0x65, 0x53, 0x69,
	0x67, 0x6d, 0x61, 0x42, 0x05, 0x5a, 0x03, 0x2f, 0x76, 0x30, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
